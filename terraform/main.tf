...
module "filestore" {
  source = "./vendor/soperator/modules/filestore"
...
module "nfs-server" {
  ...
  source = "./vendor/modules/nfs-server"
...
module "cleanup" {
  source = "./vendor/soperator/modules/cleanup"

  iam_project_id = var.iam_project_id
}

module "k8s_cleanup" {
  source = "./vendor/soperator/modules/k8s_cleanup"
...
module "k8s" {
  ...
  source = "./vendor/soperator/modules/k8s"
...
module "nvidia_operator_network" {
  ...
  source = "./vendor/modules/network-operator"
...
module "nvidia_operator_gpu" {
  ...
  source = "./vendor/modules/gpu-operator"
...
module "slurm" {
  ...
  source = "./vendor/soperator/modules/slurm"
...
module "login_script" {
  ...
  source = "./vendor/soperator/modules/login"
...
module "backups_store" {
  ...
  source = "./vendor/soperator/modules/backups_store"
...
module "backups" {
  ...
  source = "./vendor/soperator/modules/backups"
...
module "fluxcd" {
  ...
  source              = "./vendor/soperator/modules/fluxcd"
  k8s_cluster_context = module.k8s.cluster_context
}
